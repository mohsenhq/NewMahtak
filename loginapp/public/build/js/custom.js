...
function init_flot_chart() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            // a = 0;
            // for (i = 0; i < data2.newInstalls.length; i++) {
            //     a += data2.newInstalls[i];
            // }
            // var totalNumber = a;
...
function init_charts() {
    ...
    // if ($('#mybarChartOrig').length) {

    //     var ctx = document.getElementById("mybarChartOrig");
...
function init_echarts() {
    ...
    /*
        Ajax query from db for list of "Custom Events" and then after user selects them from dynamicly generated select
        gets the data for charts by Ajax.
    */
    if ($('#eventsPage').length) {
        ...
        /*
            post request for list of events 
            @url customEvent
        */
        $.ajax({
            url: '/customEvent',
            ...
            success: function(data) {
                ...
                select.onchange = function() {
                    var index = array.indexOf(this.options[this.selectedIndex].text);
                    if (index > -1) {
                        array.splice(index, 1);
                    }

                    if (this.nextElementSibling == null && array.length > 0) {
                ...
                //         clone.lastChild.options[this.lastChild.selectedIndex].remove();
                //         clone.lastChild.selectedIndex=-1;
                ...
                //         // nextSelect.lastChild.options[this.lastChild.selectedIndex].disabled=true;
                //     }
                // }
                // onclick gets the value of select elements and create charts.
                var submibBtn = document.getElementById('create');
        ...
        function ceateCharts(values) {
            // if ($('#custom').length) {
            var row = document.getElementById("eventsPage");
